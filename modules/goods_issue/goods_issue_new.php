<div class="container">
  ...
  if (isset($_POST["goodsissue_date"])) {
    $_SESSION["goodsissue_date"] = $_POST["goodsissue_date"];
  }
  else {
    $_SESSION["goodsissue_date"] = date('Y-m-d',time()); 
  }
          ...
          <table class="tablec">
            <tr class="tr">
              ...
              <tr class="tr">
                ...
                <td colspan="5" class="tdbox"><input class="textbox_wide" type="text" name="" readonly=""></td>
              </tr>
              <tr class="tr">
