...
<div class="container">
  <div class="table-wrapper" style="width: 900px; margin: 80px auto;">
    ...
    <?php 
    if($_GET["goodstransfer_id"] != $_SESSION["clear"] or $_SESSION["tam"] != "edit"){
    ...
    if(isset($_POST['addtocart'])){   
      if ($duplicate == 0) {
        ...
        while ($row = mysql_fetch_array($result)){ 
          ...
          <div class="lfield" style="padding-left: 8px;">Kho Nhập: <input style="width: 120px;" id="warehouse_in" name="warehouse_id_in" readonly="readonly" value="<?php echo $row["warehouse_name_in"] ?>"></div>
          <div class="clear"></div>
          <div class="lfield" style="padding-left: 238px">Ngày xuất: <input required="" class="txtbox" style="width: 120px;" type="text" name="goodstransfer_send_date" value="<?php echo $row["goodstransfer_send_date"] ?>" readonly="readonly"></div>
