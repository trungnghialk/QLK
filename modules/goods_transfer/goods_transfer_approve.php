 ...
 <div class="container">
  <div class="table-wrapper" style="width: 900px; margin: 80px auto;">
    ...
    if (isset($_POST["approve"])) {
      $sql = "UPDATE goods_transfer SET approve = 'pass' WHERE goodstransfer_id = '$goodstransfer_id'";
      mysql_query($sql);
    }
    ...
    <form name="add_name" id="add_name" action="" method="POST">  
      ...
      $sql = "UPDATE goods_transfer ON approve = 'pass' WHERE goodstransfer_id = $goodstransfer_id";
      mysql_query($sql);
        ?>
