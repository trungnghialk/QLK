<div class="container">
  <div class="table-wrapper" style="width: 900px; margin: 80px auto;">
    ...
    if(isset($_POST['warehouse_id_out']) && isset($_SESSION['warehouse_id_out'])){
      ...
      if(isset($_POST['warehouse_id_out'])){$_SESSION['warehouse_id_out'] = $_POST['warehouse_id_out'];}
      $duplicate =0;
        ...
        if ($duplicate == 0) {
          ...
          <form name="add_name" id="add_name" action="" method="POST">  
            ...
            <div class="modal-body">
              <div class="lbcode">Mã phiếu: <input style="text-align: center;" name="goodstransfer_id" id="order_id" readonly="readonly" value="<?php echo $_SESSION['goodstransfer_id']; ?>"></div>
              <div class="lfield">
                Kho xuất hàng: 
                <select class="txtbox" name="warehouse_id_out" id="warehouse_id" required="" onchange="select_warehouse_in()">
                ...
                <div class="lfield">Kho Nhập hàng: <select id="warehouse_in" name="warehouse_id_in"><option>Vui lòng chọn</option></select></div>
                <div class="clear"></div>
                <div class="lfield">Ngày xuất hàng: <input required="" class="txtbox" style="width: 100px;" type="text" name="goodstransfer_send_date" value="<?php $a = getdate(); echo $a['mday'].'/'.$a['mon'].'/'.$a['year'];?>" ></div>
                <div class="lfield">Ngày nhập hàng: <input required="" class="txtbox" style="width: 100px;" type="text" name="goodstransfer_receive_date" value="<?php $a = getdate(); echo $a['mday'].'/'.$a['mon'].'/'.$a['year'];?>" ></div>
