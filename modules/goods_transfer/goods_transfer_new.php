    ...
    if ($duplicate == 0) {
      ...
      <form name="add_name" id="add_name" action="" method="POST">  
        ...
        <div class="modal-body">
          <div class="lbcode">Mã phiếu chuyển: <input style="text-align: center; width: 120px; " name="goodstransfer_id" id="order_id" readonly="readonly" value="<?php echo $_SESSION['goodstransfer_id']; ?>"></div>
          <div class="lfield">
            Kho xuất: 
            <select style="width: 130px" class="txtbox" name="warehouse_id_out" id="warehouse_id" required="" onchange="select_warehouse_in()">
            ...
            <div class="lfield" style="padding-left: 8px">Kho nhập: <select style="width: 130px;" class="txtbox" id="warehouse_in" name="warehouse_id_in">
              ...
              <div style="padding-left: 233px;" class="lfield">Ngày xuất: <input required="" class="txtbox" style="width: 130px;" type="date" min="2018-01-01" max="2020-12-30" name="goodstransfer_send_date" value="<?php echo $_SESSION['goodstransfer_send_date'];?>" ></div>
              <div class="lfield">Ngày nhập: <input required="" class="txtbox" style="width: 130px;" type="date" min="2018-01-01" max="2020-12-30" name="goodstransfer_receive_date" value="<?php echo $_SESSION['goodstransfer_receive_date'];?>" ></div>

              <div class="clear"></div>
              <div>Ghi chú: <br>
                <textarea name="goodstransfer_note" style="width: 760px; height: 50px;"></textarea>
              </div>
